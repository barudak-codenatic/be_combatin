import { ForbiddenException, GoneException, Inject, Injectable, NotFoundException, UnauthorizedException } from '@nestjs/common';
import { PrismaService } from 'src/prisma/prisma.service';
import { SignupDto, SendOtpDto, VerifyDto, SigninDto, ResetPasswordDto, ForgotPasswordDto } from './dto';
...
export class AuthService {
    ...
    async sendotp(dto: SendOtpDto) {
        ...
        try {
            ...
            if (user?.verified_at) return new UnauthorizedException('Email sudah verifikasi')
    ...
    async signin(dto:SigninDto) {
        ...
        if (!user || !pwMatches) throw new ForbiddenException('Email atau password salah');
    ...
    async resetPassword(userId:string, userHash:string, passwordDto:ResetPasswordDto) {
